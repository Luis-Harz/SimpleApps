...
func menu() {
	programs := []func(){apps.Main1, apps.Main2, apps.Main3, apps.Main4, apps.Main5, apps.Main6, apps.Main7, apps.Main8, apps.Main9, apps.Main10, apps.Main11, apps.Main12, apps.Main13, apps.Main14, apps.Main15, apps.Main16, apps.Main17, apps.Main18, apps.Main19, apps.Main20, apps.Update}
